...
class Avada_Widget_Style {
	 ...
	 */
	public function filter_widget_title( $title, $instance, $base_id ) {
	...
	private function init_options() {
		...
		$this->widget_options = [
			'fusion_display_title'  => [
				...
				'description' => esc_html__( 'Choose to enable or disable the widget title. Specifically usefull for WP\'s default widget titles.', 'fusion-builder' ),
				'default'     => 'yes',
				'choices'     => [
